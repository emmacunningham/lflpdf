...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sow.agency_signature'
        db.add_column('pdfmaker_sow', 'agency_signature',
                      self.gf('django.db.models.fields.CharField')(default='Sarah Richardson', max_length=255),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Sow.agency_signature'
        db.delete_column('pdfmaker_sow', 'agency_signature')
    ...
    models = {
        ...
        'pdfmaker.sow': {
            ...
            'agency_signature': ('django.db.models.fields.CharField', [], {'default': "'Sarah Richardson'", 'max_length': '255'}),
