...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sow.img'
        db.add_column('pdfmaker_sow', 'img',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pdfmaker.Assets'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Sow.img'
        db.delete_column('pdfmaker_sow', 'img_id')
