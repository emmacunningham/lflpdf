...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sow.phone'
        db.delete_column('pdfmaker_sow', 'phone_id')

    def backwards(self, orm):
        # Adding field 'Sow.phone'
        db.add_column('pdfmaker_sow', 'phone',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=123, to=orm['pdfmaker.UserProfile']),
                      keep_default=False)
