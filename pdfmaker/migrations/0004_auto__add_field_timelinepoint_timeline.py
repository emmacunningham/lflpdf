...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimelinePoint.timeline'
        db.add_column('pdfmaker_timelinepoint', 'timeline',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pdfmaker.Timeline']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TimelinePoint.timeline'
        db.delete_column('pdfmaker_timelinepoint', 'timeline_id')
