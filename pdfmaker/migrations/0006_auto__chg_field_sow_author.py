...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sow.author'
        db.alter_column('pdfmaker_sow', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pdfmaker.UserProfile']))
    def backwards(self, orm):

        # Changing field 'Sow.author'
        db.alter_column('pdfmaker_sow', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    models = {
        'auth.group': {
