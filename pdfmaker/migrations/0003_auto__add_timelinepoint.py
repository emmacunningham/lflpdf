...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pdfmaker_timelinepoint', (
            ...
            ('timelinecategory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pdfmaker.TimelineCategory'])),
            ('pointinformation', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
