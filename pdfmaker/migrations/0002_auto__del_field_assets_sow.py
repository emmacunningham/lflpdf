...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Assets.sow'
        db.delete_column('pdfmaker_assets', 'sow_id')

    def backwards(self, orm):
        # Adding field 'Assets.sow'
        db.add_column('pdfmaker_assets', 'sow',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['pdfmaker.Sow'], unique=True),
                      keep_default=False)
