...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimelinePoint.datehighstart'
        db.add_column('pdfmaker_timelinepoint', 'datehighstart',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TimelinePoint.datehighstart'
        db.delete_column('pdfmaker_timelinepoint', 'datehighstart')
